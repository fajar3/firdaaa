...
<body>
            ...
            <div class="panel-body">
                <form name="formlogin" method="post" action>
                    <div id="login" class="col-md-12">
                        <div id="logo"> <a href="http://uniramalang.ac.id/" target="_blank"> <img
                                    class="img-responsive" src="https://uniramalang.ac.id/wp-content/uploads/2020/11/gedung-depan-2a-1878x874.jpg" /></a></div>
                        <div class="clr"></div>
                    </div>
                    ...
                    <div id="login_content" class="col-md-12 row">
                        ...
                        <div style="margin-top: 70px;margin-left:-40px;">
                                <a style="width:120px;height:60px;text-decoration: none;padding:30px;background-color:rgb(157, 198, 252);color: rgb(255, 255, 255);border-radius:20px;" href="sesi">silahkan login</a>
                        </div>
    ...
    <script>
        ...
        let x = setInterval(function() {
            ...
            let html = "<b>" + days + "</b> hari <b>" + hours + "</b> jam <b>" + minutes + "</b> menit <b>" +
                seconds + "</b> detik ";
            $("#timer").html(html);
